    ...
    <div className="flex  flex-col-reverse lg:flex-row justify-between gap-x-10">
      <div className="w-full lg:w-2/3">
        ...
        <p className="prose prose-neutral dark:prose-invert mt-3 text-justify">
          Hello! I'm Sugiarto, a passionate and experienced Full Stack Developer with over 7 years of experience in building dynamic, responsive, and scalable web applications. My journey in the tech world started with a fascination for how things work on the internet, which led me to pursue a degree in Computer Science from Batam-Indonesian University. Since then, I've been dedicated to continuously improving my skills and staying up-to-date with the latest technologies.
        </p>
        <div className="py-3">
